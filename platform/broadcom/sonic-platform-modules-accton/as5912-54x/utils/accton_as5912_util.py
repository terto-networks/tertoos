...
kos = [
    ...
    'modprobe ym2651y',
    'modprobe accton_as5912_54x_fan',
    'modprobe optoe',
    'modprobe accton_as5912_54x_leds',
    'modprobe accton_as5912_54x_psu',
    ]
...
mknod_common = [
    'echo as5912_54x_fan 0x66 > /sys/bus/i2c/devices/i2c-2/new_device ',
    ...
    'echo as5912_54x_psu1 0x53 > /sys/bus/i2c/devices/i2c-11/new_device',
    'echo ym2651 0x5b > /sys/bus/i2c/devices/i2c-11/new_device',
    'echo as5912_54x_psu2 0x50 > /sys/bus/i2c/devices/i2c-10/new_device',
    'echo ym2651 0x58 > /sys/bus/i2c/devices/i2c-10/new_device',
    'echo as5912_54x_cpld1 0x60 > /sys/bus/i2c/devices/i2c-4/new_device',
    'echo as5912_54x_cpld2 0x62 > /sys/bus/i2c/devices/i2c-5/new_device',
    'echo as5912_54x_cpld3 0x64 > /sys/bus/i2c/devices/i2c-6/new_device']
