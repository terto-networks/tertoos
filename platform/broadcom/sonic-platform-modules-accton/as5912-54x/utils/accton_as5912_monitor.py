...
#    2/27/2018: Roy Lee modify for as5912_54x
# ------------------------------------------------------------------
...
try:
    ...
    import signal
    from as5912_54x.fanutil import FanUtil
    from as5912_54x.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = 'accton_as5912_monitor'
DUTY_MAX = 100
...
class accton_as5912_monitor(object):
    # static temp var
    _ori_temp = 0
    _new_perc = 0
    _ori_perc = 0
...
def main(argv):
    ...
    monitor = accton_as5912_monitor(log_file, log_level)
